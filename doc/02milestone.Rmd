...
For 3- and 4-grams we keep only 60% of the most frequent features due to memory restrictions.
...
for unigrams than for bigrams. The majority of words have low frequency, although there is a set of very high-frequency
words. 2-grams show a similar pattern, but tend to have lower on average, better spread frequencies.
...
Both distributions are right skewed (towards higher frequencies). It's more true for the case of unigrams, whose right tail is 'heavier'.
